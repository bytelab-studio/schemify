...
export function initValidatorFunction<Options extends RawOptions, TypeBase>(validator: ValidatorFunction<Options, TypeBase>, constructor: ValidatorConstructor, options: Options): void {
...
export function raw<Options extends RawOptions, TypeBase>(cb: (value: NonNullable<unknown>, context: ValidatorContext) => ValidatorReturn<Options, TypeBase>, constructor: ValidatorConstructor, options?: RawOptions): ValidatorFunction<Options, TypeBase> {
    ...
    initValidatorFunction(validator, constructor, options as Options);
