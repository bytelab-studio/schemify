import {BaseOptions, isValidatorSymbol, ValidatorFunction} from "./types";
...
export function isValidator(value: unknown): value is (...args: unknown[]) => ValidatorFunction<BaseOptions, unknown> {
